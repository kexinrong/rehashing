...
/** @brief Auxiliary wrapper class for deconvolution kernel for
 *         Gaussian kernel.
 */
class DeconvGaussianKernelMultivariateAux {
  public:
    ...
    typedef core::metric_kernels::DeconvGaussianKernel KernelType;
