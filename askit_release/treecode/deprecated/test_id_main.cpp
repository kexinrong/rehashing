...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  double epsilon = 0.7;
  int max_rank = num_cols;
  
  double adaptive_error = test_adaptive_id(B, num_rows, num_cols, epsilon, max_rank);

  std::cout << "F-norm error for adaptive ID approx: " << adaptive_error << "\n";
